    ...
    <!-- Sparkline -->
    <script src="{{ URL::asset('/admin_lte/plugins/sparklines/sparkline.js') }}"></script>
    <!-- JQVMap -->
    <script src="{{ URL::asset('/admin_lte/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
    <script src="{{ URL::asset('/admin_lte/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
    <!-- jQuery Knob Chart -->
    ...
    <script src="{{ URL::asset('/admin_lte/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
    <!-- Summernote -->
    ...
    <script src="{{ URL::asset('/admin_lte/dist/js/pages/dashboard.js') }}"></script>
